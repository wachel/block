...
*/
class OBJ_API TiXmlNode : public TiXmlBase
{
	friend class TiXmlDocument;
	friend class TiXmlElement;
...
/////////////////////////////////////////////////////////////////
//2009-02-09 wanglei 添加功能
//查找元素的起始位置为 从上一次找到某个元素的位置开始继续查找
	TiXmlNode* CurChild() const     { return curChild; }
	TiXmlNode* CurChild( const char * value ) const;
/////////////////////////////////////////////////////////////////
//2012-11-23 wangbin 添加功能
	// 计算子节点个数
	int CalcChildrenElementNum(const char* value) const;
/////////////////////////////////////////////////////////////////
...
//2009-02-09 wanglei 添加功能
//查找元素的起始位置为 从上一次找到某个元素的位置开始继续查找
	TiXmlNode* CurChild( const std::string& value ) const	{	return CurChild (value.c_str ());	}	///< STL std::string form.
/////////////////////////////////////////////////////////////////
	#endif
...
//2009-02-09 wanglei 添加功能
//查找元素的起始位置为 从上一次找到某个元素的位置开始继续查找
	TiXmlElement* CurChildElement( const char * value ) const;
...
//2009-02-09 wanglei 添加功能
//查找元素的起始位置为 从上一次找到某个元素的位置开始继续查找
	TiXmlElement* CurChildElement( const std::string& value ) const	{	return CurChildElement (value.c_str ());	}	///< STL std::string form.	
/////////////////////////////////////////////////////////////////
	#endif
...
*/
class OBJ_API TiXmlAttribute : public TiXmlBase
{
...
*/
class OBJ_API TiXmlAttributeSet
{
public:
	TiXmlAttributeSet();
	~TiXmlAttributeSet();
...
*/
class OBJ_API TiXmlElement : public TiXmlNode
{
public:
...
/**	An XML comment.
*/
class OBJ_API TiXmlComment : public TiXmlNode
{
public:
...
*/
class OBJ_API TiXmlText : public TiXmlNode
{
	friend class TiXmlElement;
public:
	/// Constructor.
...
*/
class OBJ_API TiXmlDeclaration : public TiXmlNode
{
public:
...
/** Any tag that tinyXml doesn't recognize is save as an
	...
	is saved.
*/
class OBJ_API TiXmlUnknown : public TiXmlNode
{
public:
...
*/
class OBJ_API TiXmlDocument : public TiXmlNode
{
public:
