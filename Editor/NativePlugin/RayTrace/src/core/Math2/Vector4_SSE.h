...
//	}
//
//	inline static const Vector4SSE &GetZero(void)
//	{
//		return g_VectorSSE_Zero;
//	}
//
//	inline static const Vector4SSE &GetOne(void)
//	{
//		return g_VectorSSE_One;
//	}
//
//	// operators
//	inline Vector4SSE &operator=(const Vector4SSE &rhs)
//	{
//		m_Vec = rhs.m_Vec;
//		return *this;
//	}
...
//}
//
//inline bool operator==(const Vector4SSE &a, const Vector4SSE &b)
//{
...
//}
//
//inline Vector4SSE operator+(const Vector4SSE &a, const Vector4SSE &b)
//{
//	Vector4SSE c;
...
//}
//
//inline Vector4SSE operator*(float f, const Vector4SSE &v)
//{
//	Vector4SSE result;
//
...
//}
//
//inline Vector4SSE operator*(const Vector4SSE &v, float f)
//{
//	Vector4SSE result;
//
//	__m128 ffff = _mm_set_ps1(f);
...
//}
//
//inline Vector4SSE operator/(const Vector4SSE &a, float f)
//{
//	Vector4SSE result;
//
//	__m128 ffff = _mm_set_ps1(f);
...
//}
//
//inline Vector4SSE operator/(float f, const Vector4SSE &a)
//{
//	Vector4SSE result;
//
//	__m128 ffff = _mm_set_ps1(f);
...
//}
//
//inline float Vector3Dotf(const Vector4SSE &a, const Vector4SSE &b)
//{
//	float result;
//
...
//}
//
//inline float VectorDotf(const Vector4SSE &a, const Vector4SSE &b)
//{
//	float result;
//
...
//}
//
//inline Vector4SSE Vector3Dot(const Vector4SSE &a, const Vector4SSE &b)
//{
//	Vector4SSE c = Vector3Dotf(a, b);
//	return c;
//}
//
//inline Vector4SSE VectorDot(const Vector4SSE &a, const Vector4SSE &b)
//{
//	Vector4SSE c = VectorDotf(a,b);
//	return c;
//}
//
//inline Vector4SSE Vector3CrossProduct(const Vector4SSE &a, const Vector4SSE &b)
//{
//	Vector4SSE result;
//
...
//}
//
//inline Vector4SSE Vector3Cross_Verify(const Vector4SSE &a, const Vector4SSE &b)
//{
//	Vector4SSE c;
//
//	c.x = a.y * b.z - a.z * b.y;
...
//}
//
//inline Vector4SSE VectorLerp(const Vector4SSE &a, const Vector4SSE &b, float t)
//{
//	Vector4SSE c;
//	
...
//}
//
//inline Vector4SSE VectorMax(const Vector4SSE &a, const Vector4SSE &b)
//{
//	Vector4SSE c;
//
...
//}
//
//inline Vector4SSE VectorGetMax(const Vector4SSE &a, const Vector4SSE &b)
//{
//	return VectorMax(a, b);
//}
//
//inline Vector4SSE VectorMin(const Vector4SSE &a, const Vector4SSE &b)
//{
//	Vector4SSE c;
//
...
//}
//
//inline Vector4SSE VectorGetMin(const Vector4SSE &a, const Vector4SSE &b)
//{
//	return VectorMin(a, b);
//}
//
//inline Vector4SSE VectorReciprocal(const Vector4SSE &a)
//{
//	Vector4SSE result;
//
...
//}
//
//inline Vector4SSE VectorSqrt(const Vector4SSE &a)
//{
//	Vector4SSE result;
//
...
//}
//
//inline Vector4SSE VectorReciprocalSqrt(const Vector4SSE &a)
//{
//	Vector4SSE result;
//
...
//}
//
//inline Vector4SSE VectorNormalize(const Vector4SSE &a)
//{
//	Vector4SSE result;
//
...
//}
//
//inline float VectorNormalizeAndGetLength(const Vector4SSE &a, Vector4SSE &result)
//{
//	float vectorlength;
//
//	__m128 r1 = _mm_mul_ps(a.m_Vec, a.m_Vec); // r1 = (x*x, y*y, z*z, w*w)
...
//}
//
//inline Vector4SSE VectorAbs(const Vector4SSE &a)
//{
//	Vector4SSE result;
//
...
//}
//
//inline Vector4SSE VectorInvertSign(const Vector4SSE &a)
//{
//	Vector4SSE result;
//
...
//}
//
//inline Vector4SSE VectorSaturate(const Vector4SSE &a)
//{
//	Vector4SSE result;
//
...
//}
//
//inline Vector4SSE VectorQuaternionToRotation(const Vector4SSE &v)
//{
//	Vector4SSE result;
//	
...
//}
//
//inline Vector4SSE VectorRotationToQuaternion(const Vector4SSE &v)
//{
//	Vector4SSE result;
//
...
//inline Vector4SSE PointToPlaneDistance(const Vector4SSE &point, const Vector4SSE &plane)
//{
//	Vector4SSE p = point;
//	p[3] = 1.0f;
...
//inline Vector4SSE MirrorPoint(const Vector4SSE &point, const Vector4SSE &plane)
//{
...
//inline Vector4SSE MirrorVector(const Vector4SSE &vector, const Vector4SSE &plane)
//{
