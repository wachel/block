...
inline Vector4CPU operator*(const Vector4CPU &v, const Matrix4x4CPU &matrix);
inline Matrix4x4CPU operator*(const Matrix4x4CPU &a, const Matrix4x4CPU &b);
...
public:
	...
	//	struct
	//	{
	//		float m_Vec0.x, m_Vec0.y, m_Vec0.z, m_Vec0.w;
	//		float m_Vec1.x, m_Vec1.y, m_Vec1.z, m_Vec1.w;
	//		float m_Vec2.x, m_Vec2.y, m_Vec2.z, m_Vec2.w;
	//		float m_Vec3.x, m_Vec3.y, m_Vec3.z, m_Vec3.w;
	//	};
...
public:
	...
	{
		m_Vec0.x = f00; m_Vec0.y = f01; m_Vec0.z = f02; m_Vec0.w = f03;
		m_Vec1.x = f10; m_Vec1.y = f11; m_Vec1.z = f12; m_Vec1.w = f13;
		m_Vec2.x = f20; m_Vec2.y = f21; m_Vec2.z = f22; m_Vec2.w = f23;
		m_Vec3.x = f30; m_Vec3.y = f31; m_Vec3.z = f32; m_Vec3.w = f33;
	}
	...
	inline const Vector4CPU &GetRow(int row)const
	{
		assert(row>=0 && row<4);
		const Vector4CPU *rows = &m_Vec0;
		return rows[row];
	}
	...
	void SetMatrix3x4(const Matrix4x4CPU &mat)
	{
		m_Vec0 = mat[0];
		m_Vec1 = mat[1];
		m_Vec2 = mat[2];
	...
	inline const Vector4CPU &operator[](int row) const
	{
		return GetRow(row);
	}
...
inline bool operator==(const Matrix4x4CPU &a, const Matrix4x4CPU &b)
{
...
inline Matrix4x4CPU operator+(const Matrix4x4CPU &a, float f)
{
...
inline Matrix4x4CPU operator+(float f, const Matrix4x4CPU &a)
{
	Matrix4x4CPU result = a;
	result += f;
	return result;
...
inline Vector4CPU operator*(const Vector4CPU &v, const Matrix4x4CPU &m)
{
	Vector4CPU result;
...
inline Vector4CPU operator*(const Matrix4x4CPU &matrix, const Vector4CPU &vec)
{
	Vector4CPU result;
...
inline Matrix4x4CPU Matrix4x4Transpose(const Matrix4x4CPU &matrix)
{
