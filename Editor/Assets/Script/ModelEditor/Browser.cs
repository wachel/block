...
public class Browser : MonoBehaviour
{
    ...
    public delegate void FunSelectedFile(string file);
    FunSelectedFile funSelectedFile;
    public bool isWindowOpened() { return WindowOpen; }
    public void OpenFile(String mainFolder,FunSelectedFile fun) {
        funSelectedFile = fun;
    ...
    public void SaveFile(String FilePath, String mainFolder, FunSelectedFile fun) {
        funSelectedFile = fun;
        if (Directory.Exists(mainFolder)) {
    ...
    void DrawBrowser(int windowID) {
        ...
        if (WinType == WindowType.Open && GUI.Button(bottom, "Open")) {
            ...
            if (File.Exists(FileToOpen) || Directory.Exists(FileToOpen)) {
                ...
                //                                                                                                      //
                //////////////////////////////////////////////////////////////////////////////////////////////////////////
                if (funSelectedFile != null) {
                    funSelectedFile(FileToOpen);
                }
        ...
        if (WinType == WindowType.Save && GUI.Button(bottom, "Save")) {
            if (File.Exists(FileToSave) || Directory.Exists(FileToSave)) {
                ...
                if (File.Exists(SaveLocation)) {
                    if (funSelectedFile != null) {
                        funSelectedFile(SaveLocation);
                    }
                }
                else if(Directory.Exists(SaveLocation)){
                    if (NameOfFileToSave != "") {
                        if (funSelectedFile != null) {
                            funSelectedFile(SaveLocation + "/" + NameOfFileToSave);
                        }
                    }
                }
